...
var MulterAzureStorage = /** @class */ (function () {
    ...
    MulterAzureStorage.prototype._handleFile = function (req, file, cb) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var blobName_1, containerName_1, options, _a, _b, blobStream, metadata, hFError_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        containerName_1 = _c.sent();
                        _a = {};
                        if (!(this._contentSettings == null)) return [3 /*break*/, 4];
                        _b = {
                            contentType: file.mimetype,
                            contentDisposition: 'inline'
                        };
                        return [3 /*break*/, 6];
                    case 4: return [4 /*yield*/, this._contentSettings(req, file)];
                    case 5:
                        _b = _c.sent();
                        _c.label = 6;
                    case 6:
                        options = (_a.contentSettings = _b,
                            _a);
                    ...
                    case 7:
                        ...
                        blobStream = this._blobService.createWriteStreamToBlockBlob(containerName_1, blobName_1, options, function (cWSTBBError, result, response) {
                            if (cWSTBBError) {
                                cb(cWSTBBError);
                            }
                            else {
                    ...
                    case 9:
                        metadata = _c.sent();
                        blobStream = this._blobService.createWriteStreamToBlockBlob(containerName_1, blobName_1, Object.assign(options, { metadata: metadata }), function (cWSTBBError, result, response) {
                            if (cWSTBBError) {
                                cb(cWSTBBError);
                            }
                            else {
    ...
    MulterAzureStorage.prototype._generateBlobName = function (req, file) {
        return new Promise(function (resolve, reject) {
            resolve(Date.now() + "-" + uuid_1.v4() + path_1.extname(file.originalname));
        });
    };
